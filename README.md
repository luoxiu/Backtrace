...
> module: BacktraceTests, function: BacktraceTests.a<A>(A) -> ()
> module: BacktraceTests, function: BacktraceTests.b(Swift.Int) -> ()
> module: BacktraceTests, function: BacktraceTests.c((Swift.Int) -> ()) -> ()
> module: BacktraceTests, function: BacktraceTests.d() -> ()
> module: BacktraceTests, function: BacktraceTests.BacktraceTests.testExample() -> ()
```
